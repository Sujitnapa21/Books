...
import (
	...
	"github.com/Sujitnapa29/app/ent"
...
// @Success 200 {array} ent.Books npm install @types/react
// @Failure 400 {object} gin.H
// @Failure 500 {object} gin.H
// @Router /bookss [get]
...
func (ctl *BooksController) register() {
	patients := ctl.router.Group("/bookss")
	patients.POST("", ctl.CreateBooks)
	patients.GET("", ctl.ListBooks)
